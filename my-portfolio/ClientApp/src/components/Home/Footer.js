      ...
      <div className="container">
        <div className="row d-flex align-items-center" style={{height: "200px"}}>
          ...
          <div className="col-lg-8 col-md-8 col-sm-12">
            <p>
              <strong>Source attributions:</strong> Project image assets produced with Midjourney and transformed with Adobe Photoshop. Base CSS layout adapted from a tutorial by Sampurna Chapagain. <br/>
