...
public class GPTService4
{

    private readonly IMemoryCache _cache;
    private readonly ILogger<GPTService4> _logger;

    public GPTService4(IMemoryCache memoryCache, ILogger<GPTService4> logger)
    {
        _cache = memoryCache;
        _logger = logger;
    }
    ...
    public async Task<string> RequestChatText(string clientId, string message)
    {
        ...
        {
            chatHistory.Add(new ChatMessage { role = "system", content = "You are a helpful assistant." });
        }

        Configuration config = CompletionConfiguration.GetChatConfiguration4();
    ...
    {
        public static Configuration GetChatConfiguration4()
        {
